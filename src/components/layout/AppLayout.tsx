...
const NAV_ITEMS: NavNode[] = [
  ...
  { to: "/suppliers", label: "الموردين", icon: Truck, permission: "suppliers.view" },
  {
    ...
    children: [
      { to: "/inventory/items", label: "إدارة المخزون", icon: Boxes, anyPermission: ["inventory.view", "inventory.manage"] },
      { to: "/inventory/new-request", label: "طلب إذن جديد", icon: FilePlus2, permission: "inventory.request" },
      { to: "/inventory/requests", label: "إدارة الطلبات", icon: ClipboardCheck, anyPermission: ["inventory.approve", "inventory.view"] },
  ...
  },
  {
    ...
    children: [
      { to: "/invoices/requests", label: "إدارة طلبات الفواتير", icon: FileText, anyPermission: ["invoices.view", "invoices.manage", "invoices.approve"] },
      { to: "/invoices/sales", label: "فواتير البيع المؤكدة", icon: ReceiptText, permission: "invoices.view" },
      { to: "/invoices/purchases", label: "فواتير الشراء المؤكدة", icon: ShoppingCart, permission: "invoices.view" },
    ],
  },
